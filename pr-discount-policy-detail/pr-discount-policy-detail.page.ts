                        ...
                        searchInput$.pipe(
                          ...
                          switchMap((term) =>
                            this.itemProvider
                              ...
                              .pipe(
                                catchError(() => of([])),
                                tap(() => (r._ItemSearchLoading = false)),
                              ),
                          ),
                        ),
                      ));
